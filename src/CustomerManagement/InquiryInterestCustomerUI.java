      ...
      confirm.addActionListener(new ActionListener() {
         public void actionPerformed(ActionEvent e) {
            ...
            if(name.equals("") || phoneNum.equals("")) {
               JOptionPane.showMessageDialog(null, "빈칸을 채워 주세요", "관심고객 확인 실패", JOptionPane.WARNING_MESSAGE);
               return;
            }
           ...
           cList = cm.inquiryCustomer(name, phoneNum, java.sql.Date.valueOf(sdf.format(birthdate)));
            ...
            if(cList.isEmpty()) {
               JOptionPane.showMessageDialog(null, "잘못된 고객 정보입니다", "잘못된 고객 정보", JOptionPane.WARNING_MESSAGE);
            }
            
            else if(cList.get(0).getInterest() == true){
            	flag = true;
            	JOptionPane.showMessageDialog(null, "관심 고객 입니다", "판매 불가", JOptionPane.WARNING_MESSAGE);   
            }else {
            	flag = false;
            	JOptionPane.showMessageDialog(null, "정상 고객 입니다", "판매 가능", JOptionPane.WARNING_MESSAGE);
            }
            setVisible(false);
         }    
      });
